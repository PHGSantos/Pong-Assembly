...
// 
// Generated using ACDS version 14.1 186 at 2017.12.04.11:29:38
...
module nios_mm_interconnect_0 (
	...
	wire  [87:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	wire         cmd_mux_src_ready;                                                                  // nios2_qsys_0_jtag_debug_module_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire  [87:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> led_s1_agent:cp_data
	...
	wire  [88:0] btn_s1_agent_rf_source_data;                                                        // btn_s1_agent:rf_source_data -> btn_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] btn_s1_agent_rsp_fifo_out_data;                                                     // btn_s1_agent_rsp_fifo:out_data -> btn_s1_agent:rf_sink_data
	...
	wire         btn_s1_agent_rdata_fifo_src_valid;                                                  // btn_s1_agent:rdata_fifo_src_valid -> btn_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] btn_s1_agent_rdata_fifo_src_data;                                                   // btn_s1_agent:rdata_fifo_src_data -> btn_s1_agent:rdata_fifo_sink_data
	wire         btn_s1_agent_rdata_fifo_src_ready;                                                  // btn_s1_agent:rdata_fifo_sink_ready -> btn_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> btn_s1_agent:cp_valid
	wire  [87:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> btn_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // btn_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> btn_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> btn_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> btn_s1_agent:cp_endofpacket
	...
	wire  [87:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire         btn_s1_agent_rp_valid;                                                              // btn_s1_agent:rp_valid -> router_005:sink_valid
	wire  [87:0] btn_s1_agent_rp_data;                                                               // btn_s1_agent:rp_data -> router_005:sink_data
	wire         btn_s1_agent_rp_ready;                                                              // router_005:sink_ready -> btn_s1_agent:rp_ready
	wire         btn_s1_agent_rp_startofpacket;                                                      // btn_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         btn_s1_agent_rp_endofpacket;                                                        // btn_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (btn_s1_agent_rdata_fifo_src_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (btn_s1_agent_rdata_fifo_src_valid),                   //                .valid
		.rdata_fifo_sink_data    (btn_s1_agent_rdata_fifo_src_data),                    //                .data
